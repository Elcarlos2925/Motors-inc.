...
<head>
    ...
    <?php //? Cargar Css ?>
    <?php echo "$FontAwesome_css $Style_css $Calendar_Events_css $Bootstrap_4_6_0_css $DataTables_css $jQuery_js";?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="button-cancel" class="btn btn-outline-danger" data-bs-dismiss="modal">Cancel</button>
                    </div>
                </div>
            </div>
        </div>
