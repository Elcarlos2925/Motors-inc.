...
$Task_Assignment='../templates/Task_Assignment.php';
...
$Program_Backups='';//!Delete
$Pass_Rate='../templates/Pass-Rate.php';
$SPI_AOI='';//!Delete
$Undefined_Item='';//!Delete
$Departament='';//?Esto es el encabezado del submenu
$Equipment_Information='';//!Delete
$Equipment_Inventory='../templates/Equipment_Inventory.php';
$User='';//?Esto es el encabezado del submenu
